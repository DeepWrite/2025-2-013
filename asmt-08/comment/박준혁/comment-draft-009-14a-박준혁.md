---
title: 009-14 박준혁의 코멘트a (과제-08) 
layout: home
nav_order: 14
parent: 009-06 김다은 (과제-08)
permalink: /asmt-08/009-06/comment-009-14
---
...
- **종합적 평가**: 서론에 논제에 대한 기존 학자의 의견들이 전반적으로 미흡한 점이 크며, 단순히'사회적 조건'이라고 표기하기보다는 이런 조건을 다양한 측면에서 먼저 살펴보는 과정이 필요할 것이다.
 
제목이 존재하지 않는다. '사랑을 자본주의 체계 속에서 상품화된'이라는 워딩 자체가 '사랑 자체가 사회적 조건에 의해 구성된 감정'이라는 내용을 함축한 표현이라고 생각한다.
...
학자의 의견과 증거, 사례 등은 명확하나 단순 나열에 그치며, 논증이 진행되는 느낌은 들지 않는다. 
...
전반적으로 서론에 기존 학자들의 논증이 부족하기 때문에, 연구 주제의 시작이 단순한 저자의 호기심에 의해서만 근거 없이 창발된 것으로 보인다. 논제를 확실히 하고 저자의 의견을 명확하게 하기 위해 이에 반대되는 기존 학자들의 논증과 현재 논의되고 있는 다양한 상황에 대해 소개하는 과정이 필요할 것이다.
...
- **종합적 평가**: 논제 설정과 학술적 의의는 명확하게 보이나, 그 논증 방법이 부족함함
 
논증의 구조가 사랑이 '사회적 조건'에 따르는 내용이 아닌, 단순한 '사회적 조건의 구성요소'에 대한 단순 나열에 그치고 있다.
...
자신의 주장을 명확하게 하고, 이에 대한 세부 논증을 하나하나 자세하게 표현해볼 필요가 있다.
...
- **종합적 평가**: 학술 문헌이 사용되기는 했으나, 핵심 논증의 뒷받침이 아닌 주변적 논증에 그치기 때문에 그리 효과적이지 못하다.

역시 위와 동일하게 학술 문헌들이 '사회적 조건'의 구성요소를 설명하는 데 그치고 있다.
...
#### **5. 서론 작성 종합 평가**: 
본 연구가 기존 연구에서 어떤 점이 다른지 설명하려고 한 점은 좋았으나, 이러한 선행연구에 대한 연구가 적절한 근거 논문 없이 피상적으로 언급되었고, 단순한 인식의 확장을 위해 이루어졌다는 점에서 연구의 필요성을 명확하게 제시하지 못했으며, 때문에 논제 또한 모호해졌다.
...
#### **3. 본론 작성 종합 평가**: 
병렬적 나열의 문제가 가장 크다. 역시 논증 구조를 잘 검토해보아야 할 것이다.
...
#### **4. 결론 작성 종합 평가**: 
본론의 논증 구조를 요약한 문장을 찾기 어렵고, 기존 연구에 대한 이 연구의 차별점이 명확하게 드러나지 않아 논문이 하고자 하는 말이 명확하지 않다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

전반적으로 논문이 미완성이며, 필수 구성 요소가 많이 부족하다. 구조를 검토해보고 순서를 맞춰 차근차근 검토를 해야 하며, '사회적 조건'이란 표현에 대해 명확하게 다시 생각해 볼 필요가 있다.

### B. 논증에 대한 평가

논증 구조가 병렬적 나열로 흘러가며, 이를 전반적으로 검토해볼 필요성이 보인다.