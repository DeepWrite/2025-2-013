...
permalink: /asmt-08/009-08/comment-009-14
---
...
- **종합적 평가**: 논제가 명확히 제시되어 필자의 의도를 인식하는 데 무리가 없다.
 
형식에 대한 정의가 논증 중간에 등장하기 때문에 앞 논증에서 표현된 감각적 형식, 미적 판단 등과 핵심 논증의 연결점을 찾기 어려웠던 점이 두드러진다. 형식에 대한 정의를 앞으로 당기거나 형식과 감각의 연관성을 먼저 논증하는 방식으로 도치한다면 그 이해가 더 원활할 것이다.
...
- **종합적 평가**: 구성 요소에 무리가 없고 그 순서가 정확하며, 반론-재반박 구조도 잘 표현되었다.
...
많은 논증과 많은 반박-재반박 구조가 등장해 논증 요소를 보충하고 있으나, 이 때문에 논증이 병렬적으로 표현되어 논증 중반부부터는 그 연결성이 매끄럽지 못하다.
...
- **종합적 평가**: 논제 설정이 명확하고 훌륭한 만큼 주장하려는 바와 실익은 명확하게 드러난다.
 
논증이 중간부터 병렬적으로 진행된 만큼 그 요소들을 통합하여야 한다. 하지만 서론에서 제시된 논증구조처럼 그 통합 과정이 명확하게 보이지 않으며, 때문에 최종 결론은 보이나 그 근거가 정확하게 무엇무엇인지 파악하기 어렵다. 
...
- **종합적 평가**: 몇몇 학자들의 주장이 단순히 워딩을 차용하는 데 그치고 있다.

많은 학자들의 논증과 주장이 제시되나, 그것들이 명확하게 논증과 관련된다고 말하기 어려운 부분이 몇몇 보인다.
...
#### **5. 서론 작성 종합 평가**: 
필자 자신의 주장이 기존의 형식주의 논증과 어떻게 다른지를 명확하게 표현해 주었으면 더 명확한 논증이 보였을 것 같고, 논의가 복잡해졌음을 서론에서 소개한 만큼 단순히 그 때문에 이 논문이 필요함을 재진술해 주었으면 더 매끄럽게 읽혔을 것 같다. 
...
#### **3. 본론 작성 종합 평가**: 
논증 하나하나 떼고 본다면 괜찮으나, 병렬적 나열의 문제가 가장 크다. 역시 논증 구조를 잘 검토해보아야 할 것이다.
...
#### **4. 결론 작성 종합 평가**: 
결론 형식이 잘 맞춰져 작성되었으며, 논고의 한계를 조금 더 정확하게 제시한다면 완벽한 결론이 될 것 같다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

형식과 감각적 경험에 대한 워딩 표현을 선행해서 표현한다면 좋을 것 같다.
