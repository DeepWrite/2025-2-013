---
title: 009-01 이용우의 코멘트b (과제-08) 
layout: home
nav_order: 01
parent: 009-07 조세현 (과제-08)
permalink: /asmt-08/009-07/aomment-009-01
---
...
- **종합적 평가**: 전체적으로, 핵심 용어의 사용이 일관적이고, 논제를 진술하는 문장을 식별하기 어렵지 않지만, 같은 단락 내에서 논재의 재진술 하는 문장을 찾기 어렵다.
 
전체적으로, 핵심 용어의 사용이 일관적이고, 논제를 진술하는 문장을 식별하기 어렵지 않지만, 같은 단락 내에서 논재의 재진술 하는 문장을 찾기 어렵다.
...
논증의 핵심을 요약적으로 기술하는 부분을 찾는것이 어렵다고 느껴지며, 논제, 논증, 논제 재-진술문들의 구분을 따로 하지 않아서 명확히 구분하기가 어렵다. 각 본론 소단락 첫 문장에 “전제 ”, “근거 1: …”처럼 표지어를 넣고, 사례에는 통계·조항 번호·날짜를 넣어 실증성을 강화하면 좋을 것 같다. 
...
논문이 다루는 세부 쟁점들이 명확히 정리되어 있지 않고, 조금 모호한 부분이 있다. 
...
논문이 주장하는 바가 해결하기 힘든 딜레마에 대해서 결론을 냈다고 보기 보다는 이미 받아들여지고 있는 사실의 재확인에 가까운 것 같다. 
...
논문의 핵심 주장을 전개해 나갈때 이를 명확한 추론적 구조를 통해 제시하는 것이 아닌, 사실의 열거들로 제시하는 느낌을 받아 논변의 전체적인 구조가 불분명하게 느꼈다. 
...
<div style="border:1px solid #ddd; padding:10px; border-radius:5px;">
  <ul>
    ...
    <li><strong>유추의 경우</strong>
      <ul>
        <li>유추 대상 간의 유사성(similarity)이 결론의 관련성(relevanae)을 뒷받침하기에 충분한가?</li>
...
- **종합적 평가**: 관련 학자들의 주장과 결론을 통해 논쟁적 구조를 드러내기 보다는 단순한 나열로써 사용한 느낌이 강하며, 구체적인 논변의 활용이 부족하다. 
...
#### **5. 서론 작성 종합 평가**: 
본론에서 주장할 주장의 전개순서와 논증 구조에 대한 설명이 명확하지 않아, 본론이 어떻게 전개될 지 알기 어렵다. 
...
#### **3. 본론 작성 종합 평가**: 
각 단락들의 논증들 사이의 관계가 필연적으로 이어지기 보다는 병렬적으로 나열되어, 결론과의 연계가 느슨하다. 또한 반론이 논증의 약점이나 취약점을 공격하고 있지 못한다. 
...
#### **4. 결론 작성 종합 평가**: 
결론이 확대된 부분이 있으며, 기존 연구와의 관계를 찾기 힘들다. 

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

본 논증문은 ‘기술적 완전성 이전의 입법 정당화’라는 시의성 높은 주제를 택했으며, 서론에서 문제의식을 비교적 명료하게 제시한다는 장점이 있다. 다만 로드맵 문장 부재, 전제·근거·소결 구조 미흡, 단락 간 연결고리 부족으로 인해 전체 논증 흐름이 병렬적으로 보인다. 

### B. 논증에 대한 평가

논문이 설정한 대립 구도 “기술 미비로 입법 보류와 사회적 신호로서 선제 입법”  는 분명하지만, 논증의 추론적 구조가 불분명하여, 제와 결론 사이의 필연적 귀결이 불충분하다. 특히 세부 쟁점 구획이 모호하고, 각 쟁점별 근거의 전제 증명력이 약하며, 예상반론이 논증의 논리적 취약점을 실질적으로 건들이지 못한 부분이 아쉽다. 전제를 도식화하고, 각 전제에 실증 자료·판례·통계치를 결합하며, 반론·재반박을 심화해 ‘필연적 귀결’ 구조를 명시한다면 논증적 설득력이 크게 향상될 것이다.