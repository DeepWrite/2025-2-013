---
title: 009-01 이용우의 코멘트c (과제-08) 
layout: home
nav_order: 01
parent: 009-09 이다영 (과제-08)
permalink: /asmt-08/009-09/comment-009-01
---
...
논제 진술문들이 충분히 식별가능하고, 의도를 일관적으로 전달하고 있다.  
...
논증의 진술문과 이를 뒷받침하는 증거나 사례는 제시되어 있으나, AI 기술의 비약적인 발전 속도를 고려할 때, 보다 최근의 논문이나 자료를 인용한다면 논제에 대한 옹호 논증의 설득력이 더욱 강화될 수 있을 것이다.
...
논문이 도전하는 쟁점들에 대해서는 자세히 소개하였으나, 논문의 핵심적 딜레마가 분명하게 서술되지 않아서, 세부 쟁점들이 결국 어떠한 딜레마를 해소시키려 하는지 명확하게 알 수가 없다. 
...
저자가 최종적으로 주장하려는 바를 명확하게 알 수는 있으나, 이 글이 주는 함축을 관행에 따른 법률적 판단정도로 평가할 수 있어, 결론의 학술적 의의나 사회적 중요성이 떨어질 수 있다. 
...
- **종합적 평가**: 
 ...
 논문의 주요 전제들에 대한 필요한 주요 논증들을 잘 표현했지만, 전체적인 추론적 전략이 정확히 기술되지 않았으며, 논변의 전체적인 구조가 불분명하다. 
...
- **종합적 평가**: AI 기술의 비약적인 발전 속도를 고려할 때, 보다 최근의 논문이나 자료를 인용한다면 논제에 대한 옹호 논증의 설득력이 더욱 강화될 수 있을 것이다.
...
#### **5. 서론 작성 종합 평가**: 
서술 순서를 구체적으로 제시하여, 앞으로의 전개에 대해 예측하기 좋으나, 추론구조와 결론과 논증의 긴밀성 부분을 강화하면 더 좋을 것 같다. 
...
#### **3. 본론 작성 종합 평가**: 
반론과 예상반론이 적절하게 수행되고 있으나, 각 단락에서 주장하는 바끼리의 필연성을 더해 결론과의 연결성을 강화하면 좋을 것 같다. 
...
#### **4. 결론 작성 종합 평가**: 
결론 부분에서 윗 글에 대한 요약은 잘 이루어졌으나, 학문적 함의가 일반화되고, 기여를 통해 해결한 문제와 기존 연구와의 차별성등이 드러나지 않았다. 

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

글 전반에서 명확한 어휘 선택과 비교적 잘 드러난 논제 진술은 강점으로 보이지만, 논리적 흐름을 이끄는 구조에 대한 설명과 단락 간 연결성이 부족해 독자가 전체 논지를 따라가는 데 어려움이 있을 수 있으므로 이를 보완하면 더 구조적 가독성 측면에서 좋아질 것 같다. 형식 측면에서는 최신의 신뢰할 만한 문헌을 더 적극적으로 인용하여 학술적 정밀성을 높이면 좋을 것 같다. 결론에서는 앞선 논의를 잘 정리하고 있으나, 학문적 기여나 정책적 함의를 더 구체적인 사례를 통해 제시하면 일반적 진술에 머무는 인상을 줄이고 글의 설득력을 높일 수 있을 것이다. 

### B. 논증에 대한 평가

딜레마 구조가 서론에서 충분히 명확히 드러나지 않아, 이후 다루는 세부 쟁점들이 어떤 긴장 관계를 풀기 위한 것인지 명확하지 않기 때문에 서론에서 딜레마를 명확하게 구조적으로 제시하고 본론에서는 이를 해소하기 위한 구조를 분명하게 제시하면 좋을 것 같다. 결론에서는 학문적 기여와 확장 가능성을 더 분명하게 보여줄 필요가 있다. 