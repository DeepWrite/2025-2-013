---
title: 013-01 박인겸의 코멘트b (과제-04) 
layout: home
nav_order: 01
parent: 013-09 조서영 (과제-04)
permalink: /asmt-04/013-09/comment-013-01
---
...
이 글은 "실명제 도입이 온라인 담론의 질적 향상에 실제로 기여하는가?"라는 주제를 토대로 실명제의 실질적 효과에 대하여 분석하고, 실명제가 불러일으키는 문제를 살펴본다. 서론에서는 실명제의 효과, 표현의 자유와 책임성 간의 긴장 등을 제시하고 Cho와 Suzor, Véliz C의 입장을 대비시키면서 쟁점을 드러낸다. 그러나 서론에서 예고한 본론의 논증과 실제 본문에서 구현된 것이 다르다. 예를 들어, 서론에서는 두 번째 단락에서 익명성의 민주적인 조건을 입증하겠다고 예고했으나, 실제 두 번째 단락에서는 실명제로 인한 다수 의견의 획일화, 비판적 역동성 감소 등의 부정적인 결과만이 기술되어 있다. 또한, 첫 번째 단락과 두 번째 단락은 논리적으로 연결되기보다는 독립적인 논증 두 가지가 병렬되어 있어 필연적이지 않다.

반론과 재반박 단락은 사후성과 비가역성을 토대로 자율성이 책임성보다 우선함을 효과적으로 논증하였다. 결론에서는 앞의 내용을 잘 요약하고 재구성하고 있지만, 필자의 주장을 적용할 수 있는 영역에 대한 범위 설정이 다소 모호하다. 실명제의 단기적인 효과를 인정한다는 언급이 있기는 하나, 좀 더 확실하게 한계를 설명하는 식으로 개선하면 좋을 것 같다.
