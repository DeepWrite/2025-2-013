---
title: 009-14 박준혁의 코멘트c (과제-04) 
layout: home
nav_order: 14
parent: 009-06 김다은 (과제-04)
permalink: /asmt-04/009-06/comment-009-14
---
...
반박은 논증의 논리구조에서 가장 취약한 점을 찝는 것. 즉 '미의 기준은 시대에 따라 달라져왔다', '사회 권력 집단은 보편 미를 결정하는 판단에 관여한다'에 대한 핵심 반박이여야 함. 하지만 로저 스크루턴은 해당 개념에 반박하는 것이 아닌 '보편 미는 객관적 판단에 근거한다'라는 새로운 논증을 전개함. 때문에 이에 대한 재반박 자체가 논증을 강화한다고 보기 어렵다. 이것을 재반박 논증이 결론에서는 등장하지 않은 것으로도 확인할 수 있다.

결론의 구성 요소에 미흡한 점이 많다. 해당 논증과 다른 논문의 차별점, 연구의 근본적 의의 등이 모두 결론에 존재하지 않는다. 때문에 결론이 단순 요약과 당부의 문단이 되어 결론 문단의 역할을 다하지 못했다고 보인다.
