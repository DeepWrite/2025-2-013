---
title: 013-17 백지성의 코멘트b (과제-04) 
layout: home
nav_order: 17
parent: 013-13 윤현철 (과제-04)
permalink: /asmt-04/013-13/comment-013-17
---
...
이 글은 'AI는 혁신적으로 고용을 창출하는가, 일자리를 위협하는가'라는 고전적 논쟁을 정면으로 잡고, 'AI는 결국 일자리를 줄일 것'이라는 결론을 선명하게 내건다. 서론에서 쟁점 지도 (낙관론 vs 비관론)을 간단히 펼치고, 본론의 진행 계획을 미리 제시한 점은 독자 안내 기능이 좋다. 본론의 1, 2단락은 각각 반복노동의 자동화와 전문직 대체 가능성을 서로 다른 층위의 근거로 배치하여 논지의 범위를 넓힌다. 다만, 두 개의 근거가 순고용 감소라는 같은 결론으로 어떻게 연결되는지 사이의 추론 고리가 빠져 있어, 병렬적 나열의 인상이 남는다. 인용 역시 각각이 다루는 범위와 시차, 방법론의 차이를 짚어 주었더라면 근거의 적합성이 더 설득력 있게 확보되었을 것이다.

반론, 재반박 파트는 구조적으로 갖춰졌으나, 내용 면에서는 낙관론의 핵심 메커니즘을 충분히 공격하지 못한다. 재반박은 'AI의 속성이 고용 최소화'라는 단정과 '신규 일자리는 고숙련 중심'이라는 관찰을 제시하지만, 이를 정책, 제도적 변수와 분리해 일반화하면서 결론을 과도히 확대한다. 결론부의 '사회 파멸' 진술은 문제의식을 환기하지만, 본문에서 축적된 논증의 강도 대비 스케일이 커서 과장 효과가 난다. 반대로, 결론 말미의 정책 제안은 방향은 옳으나 구체성이 부족해 글의 응집력을 떨어뜨린다. 전체적으로 논지의 방향과 구성이 명확한 데에 반해, 반론이나 결론에서 한 단계 정밀화가 요구된다.
