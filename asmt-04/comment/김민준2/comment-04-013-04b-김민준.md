---
title: 013-04 김민준의 코멘트b (과제-04) 
layout: home
nav_order: 04
parent: 013-12 강지운 (과제-04)
permalink: /asmt-04/013-12/comment-013-04
---
...
이 글은 여러 학자들의 의견을 제시하며, "안보 딜레마는 집단 안보를 통해 해결 가능한가?"라는 질문에서 안보 딜레마가 집단 안보를 통해 해결하는 것은 불가능하며 세력 균형이 더 효과적인 메커니즘이라고 주장하고 있다. 이 글의 서론에서는 여러 학자들의 의견을 제시하여 양질의 배경을 제공한 점, 또한 여러 어휘를 통하여 글의 전개 순서를 나타낸 점이 훌륭하다. 그러나 글의 전개에서 논증적 흐름이 제대로 드러나지 않은 부분이 있는데, '무정부가 안보딜레마를 불가피하게 불러온다'와 '집단 안보체제가 현실적으로는 작동하지 않는다'의 두 논증이 "세력 균형이 더 효과적인 메커니즘이다"라는 주장에 있어 연역적인 근거로 성립되지 못하고 있다. 이 부분을 해결하기 위해서 본인의 주장의 범위가 어디까지인지, 이를 어떻게 논리적으로 정립할 수 있을지 글의 구조를 재확인하는 것이 필요해 보인다.

기본적으로 본론과 결론도 본인의 주장울 뒷받침하는 근거와 예시로 구성되어 있으나 몇몇 부분에서 개선이 필요해 보인다. 서론의 글의 전개에 대한 공통적인 문제점이기도 하지만, 본론에서 다루는 두 논증이 개인의 주장과 밀접하게 연결되어 있지 않고 있다. 오히려 연역적이라기보다는 병렬적인 근거로 구성된 것처럼 보이며, 논리를 바꾸는 등의 개선이 필요하다. 또한 결론에서, 본인의 글의 기여에 대한 부분을 서술하지 않았고, 본론에는 없었던 '세력균형이 더 효과적이다'라는 부분이 갑자기 등장하고 있다. 그렇지만 반론과 재반박 부분에서는 본인의 논증의 취약점을 찌르는 (실제로 협력적 해결이 있어왔다) 반론을 들고, 이는 유명무실한 것이라고 재반박하여 본인의 의견을 공고히 하고 있다는 점에서 훌륭하다. 따라서 글의 논리적 전개를 조금만 수정하고 디테일을 추가한다면 보다 좋은 글이 될 것이다.
