---
title: 013-13 윤현철의 코멘트c (과제-04) 
layout: home
nav_order: 13
parent: 013-21 이현중 (과제-04)
permalink: /asmt-04/013-21/comment-013-13
---
...
위 학생은 감염병 펜데믹이 도래한 상황 속에서, 스마트폰의 접촉 추적 앱을 어떤 방식으로 설계해야하는지, 즉 설계의 원칙을 다루면서 기본은 분산형으로 하고 어떤 특정한 조건이 생긴 경우에만 중앙 집중형 방식을 사용해야한다는 한쪽만 지지하는 것이 아닌, 절충된 절충적인 입장을 보여준다.

분산형으로 설계를 하게되면, 시민의 신뢰도가 자연스럽게 높아지고 이를 통해 시민의 참여율을 높이고, 결국 실효성을 확보할 수 있다는 논리전개와 중앙집중형 설계방식의 경우에는 효용이 어떠한 엄격하고 절차적인, 제도와 기술적인 조건의 전제에서만 정당화가 될 수 있을 것이라는 분석을 균형감 있게 잘 전개했다.

반론과 재반박의 구조는 매우 명확하며, 완결성이 매우 높은 논증을 제시하게 된다. 특히 제도적, 기술적인 인자들을 잘 결합하여 독창성을 크게 들어낸다고 할 수 있다.

다만, 앞서 언급한 참여율의 부족성에 대한 실제 사례와 같은 실증적인 근거의 부고함과, 제도적인 장치의 현실적인 효과에 대한 구체성.명확성 부족, 또, 국제적 시사점은 거의 언급되지 않는다는 점이 아쉽다. 

위 글은 전반적으로 실효성과 권리의 균형을 양쪽 모두 잘 표현하며 탐구한 설득력이 매우 높은 논증문이라고 할 수 있다.
