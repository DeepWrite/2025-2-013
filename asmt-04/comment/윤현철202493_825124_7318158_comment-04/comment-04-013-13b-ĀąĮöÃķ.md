...
다음 학생은 '의료적인 조력에 의한 죽음은 어떤 용어로 명명하는 것이 타당한가'라는 윤리적. 언어적 논쟁을 다루면서 MAID와 PAS라는 두 표현 방식의 차이를 분석하게 된다.

서론에서는 학술적 논쟁과 문제의 배경 상황을 소개한다. 핵심 주장을 '제도 운영 단계에서는 PAD-P/PAD-A, 학문적.윤리적 단계에서는 PAS로 전환이 필요하다'라는 방식을 전개한다. 서론에서 제시하는 글의 구조인 1. 책임과 명명 귀속, 2. 규제/통제의 혼동, 3. MAID 옹호와 반박을 자세하게 이해가 되기 쉬운 방식으로 설명하야 글의 전개를 독자가 빠르고 쉽게 이해할 수 있도록 돕는다.

본론의 첫 단락에서는 책임 귀속의 전제가 명확한 명명임을 강조하여 PAS의 투명한 분석을 옹호한다. 두 번째 단락에서는 MAID의 모호한 부분들이 구조적인 문제들을 발생시킨 다는 점을 사례와 연결지어 설명한다. 세 번째 단락에서는 선택권과 평온의 보장인 MAID 옹호론을 반론의 형태로 제시하고, 마지막 단락에서는 재반박을 통해 명명의 명확성을 강조한다. 논증의 완결성이 매우 높고, 반론.재반박의 구조가 탁월하다는 점이 장점이다.

그러나, 서론과 결론에서 모두 강조되도록 설계한 주장인 PAS와 PAD-P, PAD-A를 구분하는 방식이 본론에서 어떤 방식으로 실제 사례와 연결되는지 실제 현장의 규제 설계를 잘 알려주지 않는다는 단점이 존재한다. 또, MAID를 옹호하는 부분이 추상적이고 매우 간략하다는 점과 그것을 다시 반박하는 방식이 반복적이라는 점에서 구체적이고 명확한 근거와 자료들이 추가되면 더 높은 설득력을 보일 수 있다고 생각한다.

결론에서는 '사회적 기록과 제도 설계은 명명으로 부터 시작된다'라는 뜻을 명확히 설명한다. 논증의 구조를 다시 설명하기만 한다는 점이 약간 아쉽지만, 향후 연구 방향이나 제도적인 추가사항을 언급하거나 추가한다면 더욱 완성도가 높은 논증문이 될 것이라고 생각한다.

전반적으로 학생이 작성한 글은 명명, 명칭의 문제점을 언어의 논쟁이 아닌, 책임, 제도, 기록의 설계라는 사회적인 층위와 연결시켰다는 점에서 굉장히 완성도가 높은 논증문이라고 생각한다. 다만 반론.재반박 부분에 구체적인 실례와 PAD-A/PAD-P의 적용방식에 대한 설명이 추가되면 좋겠다는 생각이 든다.
