---
title: 013-05 김무성의 코멘트c (과제-04) 
layout: home
nav_order: 05
parent: 013-13 윤현철 (과제-04)
permalink: /asmt-04/013-13/comment-013-05
---
...
우선 서론에서는 본론이 '1. 숙련도가 낮은 노동의 대체, 2. 숙련도가 높은 노동의 대체(전문직), 3. 반론과 재반박, 4. 불평등이 이끌 사회의 위기'의 순서로 전개될 것이라고 예고했으나, 마지막 네 번째 단계에 해당하는 내용은 본론에서 독립적인 내용으로 다뤄지지 않고 재반박과 결론 단락에 부분적으로 서술되어 서론을 통해 글의 서술 흐름을 파악하는 것을 방해하고 있다. 

아울러 본문의 첫 단락(저숙련 노동 대체)과 두 번째 단락(고숙련 노동 대체)은 논리적으로 연결되지 않는 독립된 사실에 해당한다. 두 근거 간의 필연적인 논리적 흐름을 찾을 수 없다. 

본 글의 핵심 질문(AI가 일자리를 줄이는가 늘리는가)이 강의에서 강조한 딜레마에 부합하는 것인지 다시 한 번 생각해보면 좋을 것 같다. 이 질문은 사실 판단에 대한 단순 이견에 가깝다. 주제의 논리적 갈등을 좀 더 명확히 드러내려면 재반박 단락에 제시된 여러 아이디어(불평등 심화, 일자리 전환의 어려움, AI의 노동 대체 속성 등) 중 한 가지를 골라, 그에 대한 해결책을 논하는 것이 더 용이할 것 같다. 
